                    ...
                    <form action="{{ route('admin.sliders.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="checkbox" value="1" id="title_active" name="title_active" checked>
                        ...
                        <div class="mb-3">
                            ...
                            @enderror
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="checkbox" value="1" id="subtitle_active" name="subtitle_active" checked>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="color" class="form-control form-control-color @error('button_color') is-invalid @enderror" id="button_color" name="button_color" value="{{ old('button_color', '#563d7c') }}"> {{-- type="color" ve varsayılan değer --}}
                             @error('button_color')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="1" id="button_active" name="button_active" checked>
