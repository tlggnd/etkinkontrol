...
<head>
  ...
  <link href="{{asset('catalog/assets/images/favicon/favicon.png')}}" rel="icon">
  <title>@yield('title')</title>
  <link rel="stylesheet"
    href="https://fonts.googleapis.com/css?family=Rubik:400,500,600,700%7cRoboto:400,500,700&display=swap">
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.15.3/css/all.css">
  <link rel="stylesheet" href="{{asset('catalog/assets/css/libraries.css')}}">
  <link rel="stylesheet" href="{{asset('catalog/assets/css/style.css')}}">
</head>
...
<body>
  <div class="wrapper">
    ...
    <!-- =========================
        Header
    =========================== -->
    @include('catalog.layouts.header')
  ...
  <script src="{{asset('catalog/assets/js/jquery-3.5.1.min.js')}}"></script>
  <script src="{{asset('catalog/assets/js/plugins.js')}}"></script>
  <script src="{{asset('catalog/assets/js/main.js')}}"></script>
</body>
